...
import { productCategories, getProductBySlug, getAllProductSlugs } from '@/data/products';
...
function ProductDetailContent({ category, slug }: { category: NonNullable<ReturnType<typeof getProductBySlug>>; slug: string }) {
