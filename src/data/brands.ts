...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    descriptionEn: 'Swedish SIGI brand specializing in scissor lifts and vertical positioning. Products include dock lifts, work platforms and stage technology.',
    descriptionZh: '瑞典 SIGI 集團旗下品牌，專注於剪式升降設備及垂直定位。產品包括碼頭升降平台、工作平台及舞台設備。',
    descriptionDe: 'Schwedische SIGI-Marke, spezialisiert auf Scherenhubtische und vertikale Positionierung. Produkte umfassen Verladelifte, Arbeitsbühnen und Bühnentechnik.',
    productCategories: ['dock-loading'],
  },
  {
    id: 'chase',
    ...
    descriptionEn: 'UK market leader in loading bay equipment, established in 1920. Specializes in yard ramps, dock levellers, dock shelters and industrial doors.',
    descriptionZh: '英國碼頭裝卸設備市場領導者，創立於1920年。專業生產斜坡台、月台調整板、門罩及工業門。',
    descriptionDe: 'Britischer Marktführer für Verladerampen-Ausrüstung, gegründet 1920. Spezialisiert auf Verladerampen, Überladebrücken, Torabdichtungen und Industrietore.',
