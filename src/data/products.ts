  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        features: {
          en: ['Designed for cold-store and chilled-store traffic', 'Spring-return action — rapid open/close with no delay'],
          zh: ['適用於冷凍冷藏庫進出作業', '快速開閉無延遲，搭配自動回彈鉸鏈'],
          de: ['Speziell für Tiefkühl- und Kühlraumverkehr ausgelegt', 'Federrückstellung — schnelles Öffnen und Schließen ohne Verzögerung'],
        },
      },
    ],
  },
