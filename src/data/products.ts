  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        nameZh: '超大型抗風門',
        nameDe: 'Großformatiges Windsicheres Tor',
        descriptionEn: 'Oversized wind-rated doors for buildings exposed to high wind loads.',
        descriptionZh: '超大型抗風門，適用於高風壓環境。',
        descriptionDe: 'Großformatige windsichere Tore für Gebäude mit hoher Windlast.',
        images: [bp('/images/products/special-door/hoermann-rolling-shutter.jpg')],
        features: {
          en: ['Wind resistant', 'Safety certified', 'Heavy-duty construction'],
          zh: ['抗風設計', '安全認證', '重型結構'],
      ...
      },
      {
        ...
        descriptionEn: 'Large-format hangar door with translucent panels for natural daylight and a lightweight structure for easy operation.',
        descriptionZh: '大型機棚門，半透光面板引入自然採光，結構輕量化、開啟省力。',
        descriptionDe: 'Großformatiges Hangartor mit transluzenten Paneelen für Tageslicht und einer leichten Konstruktion für einfache Bedienung.',
        images: [
      ...
      },
      {
        ...
        descriptionEn: 'Twin-leaf insulated traffic door with PVC foam-core panels and spring-return hinges — rapid open/close with no delay for cold-store entry and exit.',
        descriptionZh: '雙片式保溫交通門，PVC 泡棉夾層搭配自動回彈鉸鏈，快速開閉無延遲，適用於冷凍冷藏庫進出作業。',
        descriptionDe: 'Zweiflüglige isolierte Pendeltür mit PVC-Schaumkern und Federrückstellung — schnelles Öffnen und Schließen ohne Verzögerung für Tiefkühl- und Kühlraumverkehr.',
        images: [
